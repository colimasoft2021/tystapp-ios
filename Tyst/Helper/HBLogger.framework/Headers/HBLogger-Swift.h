...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="HBLogger",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_PROTOCOL("_TtP8HBLogger10AnchorView_")
@protocol AnchorView
...
SWIFT_CLASS("_TtC8HBLogger8DropDown")
...
@interface DropDown (SWIFT_EXTENSION(HBLogger))
...
@interface DropDown (SWIFT_EXTENSION(HBLogger)) <UITableViewDataSource, UITableViewDelegate>
...
SWIFT_CLASS("_TtC8HBLogger12DropDownCell")
...
@interface DropDownCell (SWIFT_EXTENSION(HBLogger))
- (void)awakeFromNib;
...
SWIFT_CLASS("_TtC8HBLogger8HBLogger")
...
SWIFT_CLASS("_TtC8HBLogger12NFXHTTPModel")
...
SWIFT_CLASS("_TtC8HBLogger11NFXProtocol")
...
@interface NFXProtocol (SWIFT_EXTENSION(HBLogger)) <NSURLSessionDataDelegate>
...
@interface UIBarButtonItem (SWIFT_EXTENSION(HBLogger)) <AnchorView>
@property (nonatomic, readonly, strong) UIView * _Nonnull plainView;
@end
...
@interface UIView (SWIFT_EXTENSION(HBLogger)) <AnchorView>
@property (nonatomic, readonly, strong) UIView * _Nonnull plainView;
@end
...
@interface UIWindow (SWIFT_EXTENSION(HBLogger))
